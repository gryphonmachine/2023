...
public class OI {
    ...
    public static JoystickButton solenoidButton = new JoystickButton(driverController, ControllerMap.BUTTON_A);
    public static JoystickButton solenoidOffButton = new JoystickButton(driverController, ControllerMap.BUTTON_B);
    public static JoystickButton liftArmButton = new JoystickButton(driverController, ControllerMap.LBUMPER);
    public static JoystickButton dropArmButton = new JoystickButton(driverController, ControllerMap.RBUMPER);
    public static JoystickButton pushButton= new JoystickButton(driverController, ControllerMap.BUTTON_X);
    public static JoystickButton pullButton = new JoystickButton(driverController, ControllerMap.BUTTON_Y);
